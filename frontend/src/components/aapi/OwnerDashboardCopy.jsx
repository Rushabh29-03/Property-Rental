            ...
            <form onSubmit={handleAddProperty} className="space-y-6">
              ...
              <div className="flex justify-end space-x-4">
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-md font-medium transition-colors ${isSubmitting ? 'bg-gray-400 text-gray-200 cursor-not-allowed' : 'bg-indigo-600 text-white hover:bg-indigo-700'
                    }`}
                >
                  ...
                  >
                    ...
                    <div className="space-y-2" onClick={() => handleNavigate(property.id)} style={{ cursor: 'pointer' }}>
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`px-2 py-1 text-xs rounded-full ${property.isVerified ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                          }`}>
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        {propertyRequestCounts[property.id] !== undefined && (
                          <p><strong>Rent Requests:</strong>
                            <span className={`ml-1 px-2 py-1 text-xs rounded-full ${propertyRequestCounts[property.id] > 0
